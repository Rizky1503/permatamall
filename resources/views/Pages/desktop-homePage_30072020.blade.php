<div class="section">
  <div class="container">
    <div class="content-section">
      ...
      <br>
      <span>
        <a  style="cursor: pointer;" onclick="migration()" class="btn-section">Coba Sekarang</a>
      </span>
    </div>    
  ...
  <div class="container">
    ...
    <div class="content-section">
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <a  style="cursor: pointer;" onclick="migration()" class="btn-section">Daftar sebagai Murid</a>        
        </div>
        <div class="col-md-6">
          <a  style="cursor: pointer;" onclick="migration()" class="btn-section">Daftar sebagai Guru</a>
        </div>
        @elseif($private == "Mitra")
        <div class="col-md-12">
          <a  style="cursor: pointer;" onclick="migration()" class="btn-section">Guru</a>
        </div>
        @elseif($private == "Pelanggan")
        <div class="col-md-12">
          <a style="cursor: pointer;" onclick="migration()" class="btn-section">Murid</a>
        </div>
        @endif
      </div>
    </div>    
...
<div class="section">
  <div class="container">
    <div class="content-section">
      <span class="judul">BIMBINGAN OFFLINE</span>
      <p>
